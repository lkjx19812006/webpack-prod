var product = {
  ...
  doc: {
      ...
      lists: [
        {
          ...
          infos: [
            ...
            '2、本产品由复星联合健康保险股份有限公司承保，销售区域为广东省和北京市。',
            ...
            '7、本产品最低保额5万元，最高保额限制：出生满30天-17周岁，30万元；18-40周岁，50万元；41-45周岁，40万元；46-50周岁，30万元。',
    ...
    '常见问题': {
      ...
      lists: [
        {
          title: '1、什么是等待期？为什么设立等待期？',
          infos: [
            '指合同在生效的指定时间内，即时发生保险事故，受益人也不能获得保险赔偿，这段时间成为等待期。等待期是为了防止投保人隐瞒高风险因素，而投保以获得保险金的行为。本产品疾病类保障有180天的等待期。'
          ]
        },
        {
          title: '2、本产品对医院有要求吗?',
        ...
        {
          title: '5、购买保单后如何变更联系方式和联系地址？',
          infos: [
            '保单联系方式和联系地址变更可以通过复星联合健康险的微信公众号，在官方微信号-我的服务-我的保单中选择需要变更的保单进行变更即可。'
          ]
        },
        {
          title: '6、保单如何回访？',
          infos: [
            '按监管规定，保险公司会在您购买保单后的犹豫期之内对您进行回访，回访电话显示为021-80317777，请您留意接听。'
          ]
        }
      ]
    },
      ...
      'A': [
        {
          ...
          value: 'doc/B/复星联合康乐一生重大疾病保险（B款升级款）条款.pdf'
        },
        {
          label: '复星联合附加康乐一生轻症疾病保险（升级款）条款.pdf',
          value: 'doc/B/复星联合附加康乐一生轻症疾病保险（升级款）条款.pdf'
        },
        {
          label: '复星联合附加康乐一生投保人豁免重大疾病保险（升级款）条款.pdf',
          value: 'doc/B/复星联合附加康乐一生投保人豁免重大疾病保险（升级款）条款.pdf'
        }
      ],
      'B': [
        {
          label: '复星联合康乐一生重大疾病保险（C款升级款）条款.pdf',
          value: 'doc/C/复星联合康乐一生重大疾病保险（C款升级款）条款.pdf'
        },
        {
          label: '复星联合附加康乐一生投保人豁免重大疾病保险（升级款）条款.pdf',
          value: 'doc/C/复星联合附加康乐一生投保人豁免重大疾病保险（升级款）条款.pdf'
        }
      ]
    },
    '投保人声明': {
      ...
      lists: [
        {
          ...
          infos: [
            ...
            '9、本人接受保险公司在其合作方提供的电子保单作为本投保书生效。'
          ]
        }
      ]
    },
